...
public class OSSClientUtil {
    ...
    //可配置在application.yml文件中
    // endpoint以杭州为例，其它region请按实际情况填写
    private String endpoint = "oss-cn-shanghai.aliyuncs.com";
    // accessKey可换成自己申请的
    private String accessKeyId = "LTAI2La3mzCggtDh";
    //accessSecret可换成自己申请的
    private String accessKeySecret = "79kkGXfcAvCrcagzT3rsICb1IXaAm2";
    //bucket可换成自己申请的
    private String bucketName = "ddtch";
